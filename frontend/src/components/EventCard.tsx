  ...
  return (
    <Link to={`/events/${e.id}`} className="card card-hover group block">
      <div className="relative aspect-[16/10] overflow-hidden">
        <img src={e.coverImageUrl} alt={e.title} className="w-full h-full object-cover group-hover:scale-105 transition duration-500" />
      ...
      <div className="p-4">
        ...
        <h3 className="font-semibold text-slate-900 mt-1 line-clamp-2 group-hover:text-brand-600 transition">{e.title}</h3>
